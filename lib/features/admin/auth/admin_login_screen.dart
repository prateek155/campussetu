        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Info cards
              _InfoRow(icon: Icons.people_rounded,    label: 'Manage all users & access'),
              const SizedBox(height: 12),
              _InfoRow(icon: Icons.radar,             label: 'Real-time Pulse monitoring'),
              const SizedBox(height: 12),
              _InfoRow(icon: Icons.inventory_2_rounded, label: 'Events, Deals & Flatmates'),
              const SizedBox(height: 12),
              _InfoRow(icon: Icons.shield_rounded,    label: 'Detect & block suspicious activity'),
