      ...
      Row(children: [
        ...
        if (_reports.isNotEmpty)
          Container(
            ...
            child: Text('${_reports.length}', style: TextStyle(color: _red, fontSize: 12, fontWeight: FontWeight.w700)),
          ),
      ]),
      const SizedBox(height: 14),
      if (_reports.isEmpty)
          ...
          return Container(
            ...
            child: Row(children: [
              Container(
                ...
                child: Icon(Icons.flag_rounded, color: _red, size: 18),
              ),
              const SizedBox(width: 12),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Text('Resolve', style: TextStyle(color: _green, fontSize: 11, fontWeight: FontWeight.w600)),
                ),
              ),
            ]),
          );
